...
* Live: [https://api.coingate.com/v2/ips-v4](https://api.coingate.com/v2/ips-v4)
* Sandbox: [https://api-sandbox.coingate.com/v2/ips-v4](https://api-sandbox.coingate.com/v2/ips-v4)
...
* Live: [https://account.coingate.com/merchant-tools/api-integrations?tab=callbacks](https://account.coingate.com/merchant-tools/api-integrations?tab=callbacks)
* Sandbox: [https://dashboard-sandbox.coingate.com/account/apps/api-payment-callbacks](https://dashboard-sandbox.coingate.com/account/apps/api-payment-callbacks)
