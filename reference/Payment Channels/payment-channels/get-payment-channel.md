...
Retrieve a single payment channel by its ID, including its configuration (receive currency, payment purpose, callback URL) and the full list of generated deposit addresses with their current status.